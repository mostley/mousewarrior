...
namespace JCMLib
{
  public delegate void InputHandler(Message msg);
	public class NotifyIconEx : System.ComponentModel.Component
  {
    public event InputHandler InputHandlerEvent;
      ...
      public event InputHandler InputHandlerEvent;
        ...
        else if (msg.Msg == 0x00FF) // WM_INPUT
        {
          if (InputHandlerEvent != null)
          {
            InputHandlerEvent(msg);
          }
        }
        else
        {
    ...
    public IntPtr Handle
    {
      ...
      m_messageSink.InputHandlerEvent += new InputHandler(m_messageSink_InputHandlerEvent);
			data.hWnd = m_handle;
			m_id = id;
			data.uID = m_id;
    ...
    void m_messageSink_InputHandlerEvent(Message msg)
    {
      if (InputHandlerEvent != null)
      {
        InputHandlerEvent(msg);
